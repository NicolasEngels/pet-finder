...
<li className="flex my-1 hover:bg-white w-full ">
    <button className="text-xl bg-slate-300 hover:bg-blue-800 text-white flex justify-center items-center h-24 w-4"
    onClick={()=>props.delete(props.info.id)} > x
    </button>
    <div className="h-24 w-24 border overflow-hidden">
 		 <img src={props.info.profilePicture} alt="" className="object-cover h-full w-full" />
	</div>
