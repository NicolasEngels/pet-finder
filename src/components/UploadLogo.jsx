...
const UploadLogo = ({ setActive }) => {
   return (
      <div  className=" hover:shadow border rounded-3xl mt-3 p-1 px-3 flex items-center cursor-pointer justify-start text-center text-black font-bold text-lg w-30 mb-4 " 
